...
### 当一个函数作为 `new User(...)`执行时，this的变化 [ ](javascript_info_20191219101334447)

1. {{c1::一个新的空对象被创建并分配给 `this`。}}
2. {{c1::函数体执行。通常它会修改 `this`，为其添加新的属性。}}
3. {{c1::返回 `this` 的值。}}
...
## 数组方法 [	](javascript_info_20201126080456347)
### 数组方法:添加/删除元素 [	](javascript_info_20201126080456350)
| 常用方法                             | 说明                                                         |
| :----------------------------------- | :----------------------------------------------------------- |
...
### 数组方法:查询元素 [	](javascript_info_20201126080456353)
| 常用方法                         | 说明                                                         |
| :------------------------------- | :----------------------------------------------------------- |
...
### 数组方法:转换数组 [	](javascript_info_20201126080456355)
| 常用方法                | 说明                                                         |
| :---------------------- | :----------------------------------------------------------- |
...
### 数组方法:迭代元素、判断是否数组 [	](javascript_info_20201126080456358)
| 常用方法                             | 说明                                                         |
| :----------------------------------- | :----------------------------------------------------------- |
...
+ 私有字段不与公共字段发生冲突。{{c1::我们可以同时拥有私有属性 `#waterAmount` 和公共属性 `waterAmount`。}}
